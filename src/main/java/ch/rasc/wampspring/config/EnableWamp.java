...
/**
 * Add this annotation to an {@code @Configuration} class to enable WAMP
 * support:
 * 
 * <pre class="code">
 * &#064;Configuration
 ...
 * 
 * <p>
 * Or by extending the {@link WampConfigurerAdapter} class and overriding only
