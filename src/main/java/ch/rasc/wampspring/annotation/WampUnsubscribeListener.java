 ...
 * <ul>
 * <li>When the {@link #excludeSender()} attribute is true the sender of the UNSUBSCRIBE
 * message will not receive the EVENT message.</li>
 * <li>When the {@link #broadcast()} attribute is false only the sender of the UNSUBSCRIBE
