...
/**
 * Annotation that denotes a method that is called when the server receives a {@link PublishMessage} and the topicURI
 ...
 * 
 * In the following example the method can be called by sending a PublishMessage with the topicURI
 ...
 * sender of the {@link PublishMessage} does not receive an {@link EventMessage}.
 */
...
public @interface WampPublishListener {
	...
	/**
	 * Send the return value with an {@link EventMessage} to the listed topicURI(s). No {@link EventMessage} will be
	 * created when the method returns nothing (void) or null
	 */
	String[] replyTo() default {};

	/**
	 * Exclude the sender of the {@link PublishMessage} from the replyTo receivers. This attribut will be ignored if no
	 * {@link EventMessage} is created.
	 */
